/* ============================================================================
   Xkaliber — animated "code rain" background
   Faint falling columns of monospace glyphs (hex / code symbols), colored from
   the active theme accent and faded against the theme background. Subtle by
   design so it sits behind the chat without hurting readability.
   Self-contained: prepends a fixed, pointer-events:none canvas behind the UI.
   ========================================================================== */
(function () {
    'use strict';

    // Code-flavored charset (intentionally not katakana) so it reads as a
    // terminal stream rather than a movie homage.
    const GLYPHS = '01<>/\\{}[]()=+-*;:.#$%&|!?ABCDEF0123456789xff0x'.split('');
